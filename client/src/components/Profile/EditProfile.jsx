...
export default function EditProfile({ profile, projectUser }) {
  ...
  const UpdateGeneralInfo = async () => {
    const res = await fetch(`https://api.showyourproject.online/profile/generalinfo/${localStorage.id}`, {
      method: "put",
  ...
  const UpdateSocial = async (e) => {
    const res = await fetch(`https://api.showyourproject.online/profile/social/${localStorage.id}`, {
      method: "put",
      headers: { 'content-type': 'application/json' },
  ...
  const UpdateAboutMe = async () => {
    const res = await fetch(`https://api.showyourproject.online/profile/aboutme/${localStorage.id}`, {
      method: "put",
      headers: { 'content-type': 'application/json' },
  ...
  const UpdateProfilePic = async (e) => {
    ...
    const res = await fetch(`https://api.showyourproject.online/profile/pic/${localStorage.id}`, {
      method: "post",
